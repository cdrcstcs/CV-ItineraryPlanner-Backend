...
// MockSearchEngineService is a mock of SearchEngineService interface.
type MockSearchEngineService struct {
	ctrl     *gomock.Controller
	recorder *MockSearchEngineServiceMockRecorder
}

// MockSearchEngineServiceMockRecorder is the mock recorder for MockSearchEngineService.
type MockSearchEngineServiceMockRecorder struct {
	mock *MockSearchEngineService
}

// NewMockSearchEngineService creates a new mock instance.
func NewMockSearchEngineService(ctrl *gomock.Controller) *MockSearchEngineService {
	mock := &MockSearchEngineService{ctrl: ctrl}
	mock.recorder = &MockSearchEngineServiceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSearchEngineService) EXPECT() *MockSearchEngineServiceMockRecorder {
	return m.recorder
}

// SearchEngine mocks base method.
func (m *MockSearchEngineService) SearchEngine(ctx context.Context, req *models.SearchEngineReq) (*models.SearchEngineResp, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSearchEngineServiceMockRecorder) SearchEngine(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchEngine", reflect.TypeOf((*MockSearchEngineService)(nil).SearchEngine), ctx, req)
}
