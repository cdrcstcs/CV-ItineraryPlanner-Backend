...
func NewCreateRatingDal(mainDB *db.MainMongoDB) inf.CreateRatingDal{
	return &RatingDal{
		MainDB: (*mongo.Database)(mainDB),
	}
}
func NewGetRatingByIdDal(mainDB *db.MainMongoDB) inf.GetRatingByIdDal{
	return &RatingDal{
		MainDB:(*mongo.Database)(mainDB),
	}
}
func NewGetRatingDal(mainDB *db.MainMongoDB) inf.GetRatingDal{
	return &RatingDal{
		MainDB:(*mongo.Database)(mainDB),
	}
}
func NewUpdateRatingDal(mainDB *db.MainMongoDB) inf.UpdateRatingDal {
	return &RatingDal{
		MainDB: (*mongo.Database)(mainDB),
	}
}

func NewDeleteRatingDal(mainDB *db.MainMongoDB) inf.DeleteRatingDal {
	return &RatingDal{
		MainDB: (*mongo.Database)(mainDB),
	}
}
